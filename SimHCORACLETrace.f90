program SimHCORACLETrace
    ...
    !32  10 0.9 0.001 0.001 1 10 5000 $linecount $trace T $traceid-001-001-oracle.csv
    ...
    if(exists .and. oracleexists) then
        ...
        call SSDHCORACLETraceRuns(traceid,startrun,nruns,b,d,rho,r,f,maxPE,numreq, requests,isHotRequest, initrandom)
        deallocate(requests)
    ...
    subroutine SSDHCORACLETraceRuns(traceid,startrun,nruns,b,d,rho,r,f,maxPE,numreq, requests,isHotRequest, initrandom)
        ...
        do it=1,nruns
            ...
            call SSDHCORACLETrace(traceid, maxLBA, b,d,rho,f,maxPE,numreq,requests,isHotRequest,&
