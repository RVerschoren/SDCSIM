module hcwfsim
    ...
    public SSDHCWF, SSDHCWFTrace, SSDCOLDDCHTrace, SSDHCORACLETrace
...
!TODO: implement initDWFrandom, initDWFtrace,...
    ...
    subroutine SSDHCORACLETrace(traceid,maxLBA, b,d,rho,f,maxPE,numreq,requests,isHotRequest,runit,rng, initrandom, initempty)
        use rng, only: rng_t, randi, rng_uniform
