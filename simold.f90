module sim
    use utils, only: dp, PrintToFile, Print2ColReal, PrintDoubleToFile, PrintInteger, PrintReal
    implicit none

    private GC,&
        SSDDWF, SSDHCWF, SSDDWFTrace, SSDHCWFTrace, LRUHCWF, LRUHCWTrace
    public SSDDWFRuns, SSDHCWFRuns, SSDDWFTraceRuns, SSDHCWFTraceRuns,&
        LRUHCWFRuns, LRUHCWFTraceRuns
